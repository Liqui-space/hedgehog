WITH
  ...
  combined AS (
    select 
      ...
      treasuryBalanceWETH.treasuryBalanceWETH as treasuryBalanceWETH,
      treasuryBalanceUSDC.treasuryBalanceUSDC as treasuryBalanceUSDC,
      treasuryBalanceOSQTH.treasuryBalanceOSQTH as treasuryBalanceOSQTH
  ...
  calculated as (
    SELECT
      *,
      (100*((tbW/1e18 + tBU/eth_close/1e6 + osqth_close*tbO/eth_close/1e18 + tbp1 + tbp2)/tS-1)) AS performance
    FROM filled
  )
